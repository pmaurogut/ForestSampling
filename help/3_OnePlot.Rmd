...
Finalmente, es importante darse cuenta, que al estimar $G$ con un relascopio, no tenemos que medir nada, solo tenemos que contar los árboles seleccionados ya que la variable de interés, en este caso $g_i=\pi \frac{dn_i²}{4}$ también aparece en $w_i$ por lo que ambos valores se cancelan. 
