...
En este ejemplo suponemos que hemos muestreado una zona de una hectárea con radio de parcela que resulta en una superficie de $1/5$ hectáreas . En nuestra parcela han entrado cuatro árboles.

![*Áreas de parcela y factores de expansión*](Factor_de_expansion.png)

Si sabemos que nuestra parcela es de $\frac{1}{5}$ hectáreas. En base a nuestras mediciones esperaríamos tener $5x4=20$ árboles en la zona a muestrear. En realidad hay 23 árboles pero podemos ver que el inverso del área de la parcela $\frac{1}{a_{inclusion}(ha)}$ nos permite aproximarnos al valor total de árboles por unidad de área, este caso una hectárea. **Básicamente extrapolamos lo que hemos medido en la parcela al resto del área.**

Al inverso del área de la parcela se le llama factor de expansión $w_i=\frac{1}{a_{inclusion}(ha)}$ y está directamente relacionado con la probabilidad de inclusión.
