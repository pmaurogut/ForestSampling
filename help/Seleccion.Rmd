...
La segunda forma de ver este problema seria centrarse en árbol. En torno a cada árbol realizaremos un círculo del radio que le corresponda en base a su diámetro. Si llamamos área de inclusión al área de dichos círculos, podemos ver que los árboles a medir serán aquellos cuyas áreas de inclusión contengan al punto de medición que hemos aleatorizado. 
