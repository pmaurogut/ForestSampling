...
La primera forma de ver cuando maestrearíamos un árbol seria centrarse en árbol. Comenzaremos trazando un círculo (del radio que corresponda en función del diámetro del árbol y tipo de parcela) en torno a cada árbol con. Llamaremos a estos círculos áreas de inclusión del árbol . La distancia entre el punto de medición y un árbol determinado será menor que el radio de parcela correspondiente, si el punto de medición cae dentro del área de inclusión o circulo trazado en torno al árbol. Es decir, los árboles a medir serán aquellos para los que el punto de medición ha caído dentro de su área de inclusión.

![*Selección de muestra vista desde el árbol con áreas de inclusión. Solo se muestrea el árbol cuya área de inclusión aparece resaltada. Las áreas de inclusión de los árboles no muestreados se muestran en gris, el área que se emplearía en el enfoque de parcela se muestra en rojo.* ](areas_inclusion_arbol.png){alt="Selección de muestra vista desde el árbol con áreas de inclusión"}
